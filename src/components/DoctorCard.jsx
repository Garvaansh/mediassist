    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-gray-100">
      <div className="p-6">
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex-shrink-0">
            <img
              src={doctor.avatar}
              alt={doctor.name}
              className="w-24 h-24 object-cover rounded-xl border-2 border-white shadow"
            />
          </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <span className="badge badge-outline">{doctor.languages}</span>
        </div>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <button className="btn btn-ghost text-primary">View Profile</button>
        </div>
      </div>
    </div>
  );
